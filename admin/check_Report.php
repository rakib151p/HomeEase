...
if ($search_id) {
    // Assuming booking_id is the correct column in both tables
    $report_sql = "SELECT * FROM report_bookings 
                   INNER JOIN booking ON report_bookings.booking_id = booking.booking_id 
                   WHERE booking.booking_id = $search_id 
            ...
            <table class="table-auto w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-200">
                        ...
                        <th class="border border-gray-300 p-2">Service Provider Id</th>
